...
<head>
    ...
    <link type="text/css" href="CSS/<?php echo ($version) ?>/Compiled/courses.css" rel="stylesheet">
    ...
    <link type="text/css" href="CSS/<?php echo ($version) ?>/projects/explanationsText.css" rel="stylesheet">
    <link type="text/css" href="CSS/<?php echo ($version) ?>/projects/explanationsImg.css" rel="stylesheet">
    <link type="text/css" href="CSS/<?php echo ($version) ?>/projects/explanationsLogo.css" rel="stylesheet">
    <link type="text/css" href="CSS/<?php echo ($version) ?>/projects/explanationsIcon.css" rel="stylesheet">
